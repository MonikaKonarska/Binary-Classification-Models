...
This is a case study of machine learning models (R programming) using credit default data.
In this repository you can find also some solutions about data cleaning, data enginerring or some methods how present data at charts using R programming. In this project, I try to illustrate the complete workflow (I indicate the script where you can find more R programming details).
...
Dataset used from **Kaggle Lending Club**. To import dataset it is needed to download a file <em>loan.csv</em> from this [website](https://www.kaggle.com/wendykan/lending-club-loan-data). This file contains loan data for all loans issued through the 2007-2015. The file is a matrix of about 890 thousand observations and 75 variables. To import data you can use `0a.importData.R` 
