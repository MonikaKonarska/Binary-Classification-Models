...
In this report you can find also some solutions about data cleaning, data enginerring or some methods how present data at charts using R programming. In this project, I try to illustrate the complete workflow (I indicate the script where you can find more R programming details).
...
Let's check how the number of bad customers has evolved at the time.
